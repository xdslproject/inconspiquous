...
// CHECK-NEXT: %q1_6 = gate.constant #gate.x
// CHECK-NEXT: %q1_7 = gate.constant #gate.id<1>
// CHECK-NEXT: %q1_8 = arith.select %q1_5, %q1_6, %q1_7 : !gate.type<1>
...
// CHECK-NEXT: %q1_15 = arith.select %q1_14, %q1_6, %q1_7 : !gate.type<1>
...
// CHECK-NEXT: %q1_25 = arith.select %q1_24, %q1_6, %q1_7 : !gate.type<1>
