...
// CHECK-NEXT: %q1_8 = arith.select %q1_4, %q1_6, %q1_7 : !instrument.type<1>
...
// CHECK-NEXT: %q1_15 = arith.select %q1_13, %q1_6, %q1_7 : !instrument.type<1>
...
// CHECK-NEXT: %q1_25 = arith.select %q1_23, %q1_6, %q1_7 : !instrument.type<1>
