...
%q6 = qssa.dyn_apply<%g> %q5
%m = measurement.constant #measurement.comp_basis
%1 = qssa.dyn_measure<%m> %q6

// CHECK:      %q0 = qu.alloc
// CHECK-NEXT: %q1 = qu.alloc
// CHECK-NEXT: qref.apply<#gate.h> %q0
// CHECK-NEXT: qref.apply<#gate.rz<0.5pi>> %q1
// CHECK-NEXT: qref.apply<#gate.cx> %q0, %q1
// CHECK-NEXT: %{{.*}} = qref.measure %q0
// CHECK-NEXT: %g = instrument.constant #gate.h
// CHECK-NEXT: qref.dyn_apply<%g> %q1
...
// CHECK-ROUNDTRIP-NEXT: %q0_1 = qssa.apply<#gate.h> %q0
// CHECK-ROUNDTRIP-NEXT: %q1_1 = qssa.apply<#gate.rz<0.5pi>> %q1
// CHECK-ROUNDTRIP-NEXT: %q0_2, %q1_2 = qssa.apply<#gate.cx> %q0_1, %q1_1
// CHECK-ROUNDTRIP-NEXT: %{{.*}} = qssa.measure %q0_2
// CHECK-ROUNDTRIP-NEXT: %g = instrument.constant #gate.h
// CHECK-ROUNDTRIP-NEXT: %q1_3 = qssa.dyn_apply<%g> %q1_2
