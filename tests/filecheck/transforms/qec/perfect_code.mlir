...
// CHECK-NEXT:   %5 = arith.select %4, %x, %id : !instrument.type<1>
// CHECK-NEXT:   %q1_4 = qssa.dyn_gate<%5> %q1_3
// CHECK-NEXT:   %6 = arith.andi %3, %s1 : i1
// CHECK-NEXT:   %7 = arith.select %6, %z, %id : !instrument.type<1>
...
// CHECK-NEXT:   %12 = arith.select %11, %x, %id : !instrument.type<1>
// CHECK-NEXT:   %q2_4 = qssa.dyn_gate<%12> %q2_3
// CHECK-NEXT:   %13 = arith.andi %10, %s2 : i1
// CHECK-NEXT:   %14 = arith.select %13, %z, %id : !instrument.type<1>
...
// CHECK-NEXT:   %19 = arith.select %18, %x, %id : !instrument.type<1>
// CHECK-NEXT:   %q3_4 = qssa.dyn_gate<%19> %q3_3
// CHECK-NEXT:   %20 = arith.andi %17, %s3 : i1
// CHECK-NEXT:   %21 = arith.select %20, %z, %id : !instrument.type<1>
...
// CHECK-NEXT:   %27 = arith.select %26, %x, %id : !instrument.type<1>
// CHECK-NEXT:   %q4_5 = qssa.dyn_gate<%27> %q4_4
// CHECK-NEXT:   %28 = arith.andi %25, %s1 : i1
// CHECK-NEXT:   %29 = arith.select %28, %z, %id : !instrument.type<1>
...
// CHECK-NEXT:   %34 = arith.select %33, %x, %id : !instrument.type<1>
// CHECK-NEXT:   %q5_4 = qssa.dyn_gate<%34> %q5_3
// CHECK-NEXT:   %35 = arith.andi %32, %s2 : i1
// CHECK-NEXT:   %36 = arith.select %35, %z, %id : !instrument.type<1>
// CHECK-NEXT:   %q5_5 = qssa.dyn_gate<%36> %q5_4
// CHECK-NEXT:   %a1_8 = qu.alloc
// CHECK-NEXT:   %a1_9 = qssa.gate<#gate.h> %a1_8
// CHECK-NEXT:   %a1_10, %q1_6 = qssa.gate<#gate.cx> %a1_9, %q1_5
// CHECK-NEXT:   %a1_11, %q2_6 = qssa.gate<#gate.cz> %a1_10, %q2_5
...
// CHECK-NEXT:   %a2_10, %q2_7 = qssa.gate<#gate.cx> %a2_9, %q2_6
// CHECK-NEXT:   %a2_11, %q3_7 = qssa.gate<#gate.cz> %a2_10, %q3_6
...
// CHECK-NEXT:   %a3_10, %q1_7 = qssa.gate<#gate.cx> %a3_9, %q1_6
// CHECK-NEXT:   %a3_11, %q3_8 = qssa.gate<#gate.cx> %a3_10, %q3_7
...
// CHECK-NEXT:   %a4_10, %q1_8 = qssa.gate<#gate.cz> %a4_9, %q1_7
// CHECK-NEXT:   %a4_11, %q2_8 = qssa.gate<#gate.cx> %a4_10, %q2_7
...
// CHECK-NEXT:   %id_1 = instrument.constant #gate.id<1>
...
// CHECK-NEXT:   %42 = arith.select %41, %x_1, %id_1 : !instrument.type<1>
// CHECK-NEXT:   %q1_9 = qssa.dyn_gate<%42> %q1_8
// CHECK-NEXT:   %43 = arith.andi %40, %s1_1 : i1
// CHECK-NEXT:   %44 = arith.select %43, %z_1, %id_1 : !instrument.type<1>
...
// CHECK-NEXT:   %49 = arith.select %48, %x_1, %id_1 : !instrument.type<1>
// CHECK-NEXT:   %q2_9 = qssa.dyn_gate<%49> %q2_8
// CHECK-NEXT:   %50 = arith.andi %47, %s2_1 : i1
// CHECK-NEXT:   %51 = arith.select %50, %z_1, %id_1 : !instrument.type<1>
...
// CHECK-NEXT:   %56 = arith.select %55, %x_1, %id_1 : !instrument.type<1>
// CHECK-NEXT:   %q3_9 = qssa.dyn_gate<%56> %q3_8
// CHECK-NEXT:   %57 = arith.andi %54, %s3_1 : i1
// CHECK-NEXT:   %58 = arith.select %57, %z_1, %id_1 : !instrument.type<1>
...
// CHECK-NEXT:   %64 = arith.select %63, %x_1, %id_1 : !instrument.type<1>
// CHECK-NEXT:   %q4_11 = qssa.dyn_gate<%64> %q4_10
// CHECK-NEXT:   %65 = arith.andi %62, %s1_1 : i1
// CHECK-NEXT:   %66 = arith.select %65, %z_1, %id_1 : !instrument.type<1>
...
// CHECK-NEXT:   %71 = arith.select %70, %x_1, %id_1 : !instrument.type<1>
// CHECK-NEXT:   %q5_9 = qssa.dyn_gate<%71> %q5_8
// CHECK-NEXT:   %72 = arith.andi %69, %s2_1 : i1
// CHECK-NEXT:   %73 = arith.select %72, %z_1, %id_1 : !instrument.type<1>
