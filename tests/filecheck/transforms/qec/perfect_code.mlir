...
// CHECK-NEXT:   %a1_2, %q1_1 = qssa.gate<#gate.cnot> %a1_1, %q1
// CHECK-NEXT:   %a1_3, %q2_1 = qssa.gate<#gate.cz> %a1_2, %q2
// CHECK-NEXT:   %a1_4, %q3_1 = qssa.gate<#gate.cz> %a1_3, %q3
// CHECK-NEXT:   %a1_5, %q4_1 = qssa.gate<#gate.cnot> %a1_4, %q4
...
// CHECK-NEXT:   %a2_2, %q2_2 = qssa.gate<#gate.cnot> %a2_1, %q2_1
// CHECK-NEXT:   %a2_3, %q3_2 = qssa.gate<#gate.cz> %a2_2, %q3_1
// CHECK-NEXT:   %a2_4, %q4_2 = qssa.gate<#gate.cz> %a2_3, %q4_1
// CHECK-NEXT:   %a2_5, %q5_1 = qssa.gate<#gate.cnot> %a2_4, %q5
...
// CHECK-NEXT:   %a3_2, %q1_2 = qssa.gate<#gate.cnot> %a3_1, %q1_1
// CHECK-NEXT:   %a3_3, %q3_3 = qssa.gate<#gate.cnot> %a3_2, %q3_2
...
// CHECK-NEXT:   %a4_3, %q2_3 = qssa.gate<#gate.cnot> %a4_2, %q2_2
// CHECK-NEXT:   %a4_4, %q4_4 = qssa.gate<#gate.cnot> %a4_3, %q4_3
...
// CHECK-NEXT:   %a1_9, %q1_6 = qssa.gate<#gate.cnot> %a1_8, %q1_5
// CHECK-NEXT:   %a1_10, %q2_6 = qssa.gate<#gate.cz> %a1_9, %q2_5
// CHECK-NEXT:   %a1_11, %q3_6 = qssa.gate<#gate.cz> %a1_10, %q3_5
// CHECK-NEXT:   %a1_12, %q4_7 = qssa.gate<#gate.cnot> %a1_11, %q4_6
...
// CHECK-NEXT:   %a2_9, %q2_7 = qssa.gate<#gate.cnot> %a2_8, %q2_6
// CHECK-NEXT:   %a2_10, %q3_7 = qssa.gate<#gate.cz> %a2_9, %q3_6
// CHECK-NEXT:   %a2_11, %q4_8 = qssa.gate<#gate.cz> %a2_10, %q4_7
// CHECK-NEXT:   %a2_12, %q5_6 = qssa.gate<#gate.cnot> %a2_11, %q5_5
...
// CHECK-NEXT:   %a3_9, %q1_7 = qssa.gate<#gate.cnot> %a3_8, %q1_6
// CHECK-NEXT:   %a3_10, %q3_8 = qssa.gate<#gate.cnot> %a3_9, %q3_7
...
// CHECK-NEXT:   %a4_10, %q2_8 = qssa.gate<#gate.cnot> %a4_9, %q2_7
// CHECK-NEXT:   %a4_11, %q4_10 = qssa.gate<#gate.cnot> %a4_10, %q4_9
