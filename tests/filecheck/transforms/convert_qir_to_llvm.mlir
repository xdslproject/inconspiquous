...
// CHECK: llvm.call @__quantum__rt__qubit_allocate
...
// CHECK-NEXT: llvm.call @__quantum__qis__h__body
...
// CHECK: llvm.call @__quantum__rt__qubit_allocate
%1 = qir.qubit_allocate
// CHECK: llvm.call @__quantum__qis__h__body
qir.h %0
// CHECK: llvm.call @__quantum__qis__cnot__body
qir.cnot %0, %1
// CHECK: llvm.call @__quantum__qis__m__body
%2 = qir.m %0
// CHECK: llvm.call @__quantum__qis__m__body
%3 = qir.m %1
// CHECK: llvm.call @__quantum__rt__result_equal
