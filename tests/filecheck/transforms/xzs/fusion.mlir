...
// CHECK:      func.func @fusion(%q : !qubit.bit, %x1 : i1, %x2 : i1, %z1 : i1, %z2 : i1, %s1 : i1, %s2 : i1) -> !qubit.bit {
...
// CHECK-NEXT: }
func.func @fusion(%q: !qubit.bit, %x1: i1, %x2: i1, %z1: i1, %z2: i1, %s1: i1, %s2: i1) -> !qubit.bit {
...
// CHECK:      func.func @fusion_backwards(%q : !qubit.bit, %x1 : i1, %x2 : i1, %z1 : i1, %z2 : i1, %s1 : i1) -> !qubit.bit {
...
// CHECK-NEXT:   func.return %q_1 : !qubit.bit
// CHECK-NEXT: }
func.func @fusion_backwards(%q: !qubit.bit, %x1: i1, %x2: i1, %z1: i1, %z2: i1, %s1: i1) -> !qubit.bit {
  %g1 = gate.xzs %x1, %z1, %s1
