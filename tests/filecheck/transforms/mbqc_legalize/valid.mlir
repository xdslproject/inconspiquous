...
// CHECK-NEXT:   %q3 = qu.alloc<#qu.plus>
// CHECK-NEXT:   %q1_1, %q2_1 = qssa.apply<#gate.cz> %q1, %q2
// CHECK-NEXT:   %q2_2, %q3_1 = qssa.apply<#gate.cz> %q2_1, %q3
...
// CHECK-NEXT:   %q1_1, %q2_1 = qssa.apply<#gate.cz> %q1, %q2
// CHECK-NEXT:   %q2_2, %q3_1 = qssa.apply<#gate.cz> %q2_1, %q3
// CHECK-NEXT:   %q1_2 = qssa.apply<#gate.x> %q1_1
// CHECK-NEXT:   func.return %q3_1 : !qu.bit
// CHECK-NEXT: }
