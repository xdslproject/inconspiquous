...
// CHECK-NEXT:   %q1 = qssa.gate<#gate.x> %q0
...
// CHECK-NEXT:   %q0 = qu.alloc
// CHECK-NEXT:   %q1 = qssa.gate<#gate.x> %q0
// CHECK-NEXT:   %q2 = qssa.gate<#gate.z> %q1
// CHECK-NEXT:   func.return
// CHECK-NEXT: }
...
// CHECK-NEXT:   %q2 = qssa.gate<#gate.x> %q0
// CHECK-NEXT:   %q3 = qssa.gate<#gate.y> %q1
// CHECK-NEXT:   func.return
// CHECK-NEXT: }
...
// CHECK-NEXT:   %q0 = qu.alloc
// CHECK-NEXT:   %q1 = qu.alloc
// CHECK-NEXT:   %q2 = qssa.gate<#gate.h> %q0
// CHECK-NEXT:   %q3, %q4 = qssa.gate<#gate.cx> %q2, %q1
// CHECK-NEXT:   func.return
// CHECK-NEXT: }
...
// CHECK-NEXT:   %q0 = qu.alloc
// CHECK-NEXT:   %q1 = qssa.gate<#gate.x> %q0
// CHECK-NEXT:   %final = qssa.gate<#gate.z> %q1
// CHECK-NEXT:   func.return
// CHECK-NEXT: }
