...
// CHECK-NEXT: %q0_1 = qssa.apply<#gate.h> %q0
// CHECK-NEXT: %q1_1 = qssa.apply<#gate.rz<0.5pi>> %q1
// CHECK-NEXT: %q0_2, %q1_2 = qssa.apply<#gate.cx> %q0_1, %q1_1
// CHECK-NEXT: %{{.*}} = qssa.measure %q0_2
// CHECK-NEXT: %g = instrument.constant #gate.h
// CHECK-NEXT: %q1_3 = qssa.dyn_apply<%g> %q1_2
...
// CHECK-ROUNDTRIP-NEXT: qref.apply<#gate.h> %q0
// CHECK-ROUNDTRIP-NEXT: qref.apply<#gate.rz<0.5pi>> %q1
// CHECK-ROUNDTRIP-NEXT: qref.apply<#gate.cx> %q0, %q1
// CHECK-ROUNDTRIP-NEXT: %{{.*}} = qref.measure %q0
// CHECK-ROUNDTRIP-NEXT: %g = instrument.constant #gate.h
// CHECK-ROUNDTRIP-NEXT: qref.dyn_apply<%g> %q1
...
// CHECK-NEXT:   qref.apply<#gate.z> %q
