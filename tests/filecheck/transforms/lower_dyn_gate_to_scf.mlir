...
// CHECK-NEXT:    scf.if %b {
// CHECK-NEXT:      qref.dyn_apply<%g1> %q
// CHECK-NEXT:    } else {
// CHECK-NEXT:      qref.dyn_apply<%g2> %q
// CHECK-NEXT:    }
qref.dyn_apply<%g5> %q
...
// CHECK-NEXT:    }
// CHECK-NEXT:    case -2 {
// CHECK-NEXT:      qref.dyn_apply<%g3> %q
// CHECK-NEXT:      scf.yield
// CHECK-NEXT:    }
// CHECK-NEXT:    case -1 {
// CHECK-NEXT:      qref.dyn_apply<%g4> %q
// CHECK-NEXT:      scf.yield
// CHECK-NEXT:    }
// CHECK-NEXT:    default {
// CHECK-NEXT:      qref.dyn_apply<%g1> %q
