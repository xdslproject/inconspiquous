...
// CHECK-NEXT:   %q1_5, %q1_6 = qssa.apply<#gate.cz> %q1, %q1_1
// CHECK-NEXT:   %0, %1 = qssa.apply<#gate.cz> %q1_6, %q1_2
// CHECK-NEXT:   %2, %3 = qssa.apply<#gate.cz> %1, %q1_3
// CHECK-NEXT:   %4, %5 = qssa.apply<#gate.cz> %3, %q1_4
...
// CHECK-NEXT:   %q1_22 = qssa.dyn_apply<%6> %5
// CHECK-NEXT:   func.return %q1_22 : !qu.bit
// CHECK-NEXT: }
func.func @rotation(%phi: !angle.type, %theta: !angle.type, %lambda: !angle.type, %q1: !qu.bit) -> !qu.bit {
  %q1_1 = qssa.apply<#gate.j<0>> %q1
  %g1 = gate.dyn_j<%lambda>
  %q1_2 = qssa.dyn_apply<%g1> %q1_1
  %g2 = gate.dyn_j<%theta>
  %q1_3 = qssa.dyn_apply<%g2> %q1_2
  %g3 = gate.dyn_j<%phi>
  %q1_4 = qssa.dyn_apply<%g3> %q1_3
