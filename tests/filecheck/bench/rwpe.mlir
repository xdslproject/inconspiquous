...
// CHECK-NEXT:    %8 = phi i64 [ %32, %13 ], [ 0, %4 ]
// CHECK-NEXT:    %9 = phi double [ %30, %13 ], [ %0, %4 ]
// CHECK-NEXT:    %10 = phi double [ %31, %13 ], [ %1, %4 ]
// CHECK-NEXT:    %11 = phi ptr [ %11, %13 ], [ %6, %4 ]
// CHECK-NEXT:    %12 = icmp slt i64 %8, %5
// CHECK-NEXT:    br i1 %12, label %13, label %33
// CHECK-EMPTY:
...
// CHECK-NEXT:    %26 = fdiv double %10, 0x3FFA61298E1E045B
// CHECK-NEXT:    %27 = fmul double %26, 0x400921FB54442D18
// CHECK-NEXT:    %28 = fneg double %27
// CHECK-NEXT:    %29 = select i1 %25, double %28, double %27
// CHECK-NEXT:    %30 = fadd double %9, %29
// CHECK-NEXT:    %31 = fmul double %10, 0x3FE97121DFB43D2C
// CHECK-NEXT:    %32 = add i64 %8, 1
// CHECK-NEXT:    br label %7
// CHECK-EMPTY:
// CHECK-NEXT:  33:                                               ; preds = %7
