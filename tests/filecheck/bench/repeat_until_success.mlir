...
// CHECK-NEXT:    %7 = call i1 @__quantum__rt__read_result__body(ptr %6)
// CHECK-NEXT:    call void @__quantum__rt__qubit_release(ptr %4)
// CHECK-NEXT:    call void @__quantum__qis__h__body(ptr %5)
// CHECK-NEXT:    %8 = call ptr @__quantum__qis__m__body(ptr %5)
// CHECK-NEXT:    %9 = call i1 @__quantum__rt__read_result__body(ptr %8)
// CHECK-NEXT:    call void @__quantum__rt__qubit_release(ptr %5)
// CHECK-NEXT:    %10 = or i1 %7, %9
// CHECK-NEXT:    br i1 %10, label %2, label %11
// CHECK-EMPTY:
...
// CHECK-NEXT:    br label %2
// CHECK-EMPTY:
// CHECK-NEXT:  2:                                                ; preds = %10, %1
// CHECK-NEXT:    %3 = phi ptr [ %3, %10 ], [ %0, %1 ]
// CHECK-NEXT:    %4 = call ptr @__quantum__rt__qubit_allocate()
// CHECK-NEXT:    call void @__quantum__qis__h__body(ptr %4)
// CHECK-NEXT:    %5 = call ptr @__quantum__rt__qubit_allocate()
// CHECK-NEXT:    call void @__quantum__qis__h__body(ptr %5)
...
// CHECK-NEXT:    call void @__quantum__qis__h__body(ptr %4)
// CHECK-NEXT:    %11 = call ptr @__quantum__qis__m__body(ptr %4)
// CHECK-NEXT:    %12 = call i1 @__quantum__rt__read_result__body(ptr %11)
// CHECK-NEXT:    call void @__quantum__rt__qubit_release(ptr %4)
// CHECK-NEXT:    call void @__quantum__qis__h__body(ptr %5)
// CHECK-NEXT:    %13 = call ptr @__quantum__qis__m__body(ptr %5)
// CHECK-NEXT:    %14 = call i1 @__quantum__rt__read_result__body(ptr %13)
// CHECK-NEXT:    call void @__quantum__rt__qubit_release(ptr %5)
// CHECK-NEXT:    %15 = or i1 %12, %14
// CHECK-NEXT:    br i1 %15, label %2, label %16
// CHECK-EMPTY:
// CHECK-NEXT:  16:                                               ; preds = %10
// CHECK-NEXT:    ret ptr %3
// CHECK-NEXT:  }
