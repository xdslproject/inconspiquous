...
// CHECK-NEXT:   qref.gate<#gate.cnot> %q2, %q3
// CHECK-NEXT:   qref.gate<#gate.t_dagger> %q3
// CHECK-NEXT:   qref.gate<#gate.cnot> %q1, %q3
// CHECK-NEXT:   qref.gate<#gate.t> %q3
// CHECK-NEXT:   qref.gate<#gate.cnot> %q2, %q3
// CHECK-NEXT:   qref.gate<#gate.t> %q2
// CHECK-NEXT:   qref.gate<#gate.t> %q3
// CHECK-NEXT:   qref.gate<#gate.cnot> %q1, %q3
// CHECK-NEXT:   qref.gate<#gate.cnot> %q1, %q2
...
func.func @toffoli(%q1 : !qubit.bit, %q2 : !qubit.bit, %q3 : !qubit.bit) -> (!qubit.bit, !qubit.bit, !qubit.bit) {
  qref.gate<#gate.h> %q3
  qref.gate<#gate.cnot> %q2, %q3
  qref.gate<#gate.t_dagger> %q3
  qref.gate<#gate.cnot> %q1, %q3
  qref.gate<#gate.t> %q3
  qref.gate<#gate.cnot> %q2, %q3
  qref.gate<#gate.t> %q2
  qref.gate<#gate.t> %q3
  qref.gate<#gate.cnot> %q1, %q3
  qref.gate<#gate.cnot> %q1, %q2
  qref.gate<#gate.t> %q1
